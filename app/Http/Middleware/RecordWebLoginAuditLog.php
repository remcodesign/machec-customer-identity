...
class RecordWebLoginAuditLog
{
     ...
     * is chained onto the `login.store` route instead (same extension-point
     * shape as `RecordServiceTokenUsageMiddleware`, D102) and only records
     * the login once `$next` confirms the session was actually established.
     */
